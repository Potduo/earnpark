      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              The world's most advanced AI-powered crypto investment platform. 
              Join millions of investors achieving financial freedom through automated trading.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2 text-gray-400">
                ...
                <span>support@earnparkpro.com</span>
              </li>
              <li className="flex items-center space-x-2 text-gray-400">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 EarnParkPro. All rights reserved.
          </p>
